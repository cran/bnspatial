...
#'   \item currentLU An object of class \href{https://cran.r-project.org/package=raster}{\code{RasterLayer}}. 
...
#' @description An object of class \href{https://cran.r-project.org/package=raster}{\code{RasterLayer}}. 
