...
## A quick tour: setting the scene
The folowing example shows the use of *bnspatial* in a hypotetical land use change context and is inspired by works like Celio et al.[^1]. The aim is to analyze how different factors can influence land use change and where the change is most likely to occur.  
